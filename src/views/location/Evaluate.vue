    ...
    <div class="box">
      <div class="box1">
        <van-tabs v-model="active">
          ...
          <van-tab title="已评价">
              <div v-for="(item,index) in ppt" :key="index">
                ...
                <div class="font2 po-2">{{ item1.name }}</div>
                  <div class="bder po-2 dis-1 al-1 ju-1" @click="see(item)">
                  <van-icon name="chat" color="red" />
                  <div class="font0">查看评论</div>
                </div>
                </div>
                </div>
              </div>
