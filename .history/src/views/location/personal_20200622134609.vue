<template>
  <div>
    ...
    <van-form>
      ...
      <van-field v-model="nickname" type="nickname" name="昵称" label="昵称" />
      <van-field v-model="gender" type="gender" name="性别" label="性别" />
      <van-field name="邮箱" label="邮箱" placeholder="请输入邮箱" />
      <van-field v-model="msg" type="msg" name="出生年月" label="出生年月" />
    </van-form>
