<template>
  ...
  <div class="content">
   <div class="dis-1 mm">
              ...
              <div class="d-f f-d-c">
                <div class="m-t2">{{obj.name}}</div>
                <div class="hong m-t1">￥{{obj.present_price}}</div>
              </div>
            </div>
            <div class="mmmm d-f j-c-s-b a-i-c">
              <div>
                <div>购买数量:</div>
                <div class="d-f m-t1">
                  <div class="hui">剩余 {{obj.amount}} 件</div>
                  <div class="hong m-l1">每人限购50件</div>
                </div>
              </div>
