      ...
      <van-tabs v-model="active">
        ...
        <van-tab title="商品评论">
           <div v-for="(item,index) in ars" :key="index">
             <div class="deb po-1">
              <div class="img"><img :src="item.comment_avatar" alt="" class="img1"></div>
            <div class="nmrs">{{item.comment_nickname}}:</div> 
            <div class="po-2 item-1">{{item.comment_time}}</div>
            <div class="po-2 van1"><van-rate v-model="item.rate" disabled disabled-color='#E03204' size="10px" /></div>
             </div>
