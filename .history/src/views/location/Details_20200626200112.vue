<template>
  <div>
    ...
    <div class="w-1 po-1">
      ...
      <van-goods-action>
  <van-goods-action-icon icon="chat-o" text="客服" /></van-goods-action>
  <van-goods-action-icon icon="shop-o" text="店铺" /></van-goods-action>
  <van-goods-action-button color="#be99ff" type="warning" text="加入购物车" /></van-goods-action>
  <van-goods-action-button color="#7232dd" type="danger" text="立即购买" /></van-goods-action>
</van-goods-action>
    </div>
  </div>
</template>
