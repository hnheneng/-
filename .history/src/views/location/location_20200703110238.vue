<templ<template>
  ...
  <div>
    ...
    <div class="city2">
      ...
      <div class='ml-20 mt-10'>当前城市</div>
    </div>
    <div class="city3 dis-1 ju-1  al-1 ml-20 mt-10">成都市</div>
    <div class="city4 dis-1 al-1 mt-10">热门城市</div>
    <div class="dis-1 city6">
      <div v-for="(item,index) in hotCities" :key="index">
        <div class="city5 dis-1 ju-1 al-1">{{item.name}}</div>
      </div>
    </div>
    <div v-if="flag===false">
    ...
    <div v-else>
      <div v-for="(item1,index1) in cityList" :key="index1">
       <div class=" ml-20 mt-10">{{item1.name}}</div>
