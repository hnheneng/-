<template>
  <div>
    ...
    <div class="back1 fl-d w-1 dis-1 al-1 ju-1 po-1">
      ...
      <div class="fz-16 color mt-10" v-if="user.code = 200" @click="sogin">退出登录</div>
      <div v-else @click="inint">登录/注册</div>
    ...
    <div class="box-1  dis-1 al-1  po-1">
        <div class="fz-14"><van-icon name="location-o" @click="Add "/> 地址管理
    </div>
    <div class="icon1 po-2">〉</div>
    </div>
