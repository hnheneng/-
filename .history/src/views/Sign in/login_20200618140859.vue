 ...
 <div>
   <div class="dis-1  ju-1">
      <img src="./12123.jpg" alt="" class="img1"/>
       ...
       <van-cell-group>
  <van-field v-model="ruleForm.username" prop="username" placeholder="USERNAME" />

  <van-field v-model="password" placeholder="PASSWORD" />

  <van-field v-model="phone" label="手机号码" placeholder="请输入用户名" />
</van-cell-group>
   <!-- 短信验证码 -->
  <van-field
  v-model="sms"
...
username:'',
     ...
     cods:'',
      username: [
          ...
          { min: 2, max: 10, message: "账号是6-16位之间", trigger: "blur" },
        ],
     }
   },
   methods: {
