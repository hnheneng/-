<template>
  <div>
    ...
    <!-- <div class="d-f j-c-c a-i-c f-d-c">
      <div>
        <img src="../../../server/可能要用的图片/loading.gif" alt width="100%" height="300" />
      </div>
      <h3>登录*后才能查看订单</h3>
      <div class="m-t2"><van-button type="primary" to="/signin">请先登录</van-button></div>
    </div>-->
    <div class="ww dis-1 sb">
      ...
      <div class="d-f j-c-c a-i-c f-d-c m-r2">
        <div>合计:</div>
        <div class="m-t1">请确认订单</div>
      </div>
    </div>
    <div class="d-f wd">
      <van-button color="#e6057f" class="btn">删除</van-button>
      <van-button color="#e6057f">去结算</van-button>
    </div>
    <!-- 循环出来的数据 -->
